...
const app = express();
const pool=new pg({host:'ec2-54-228-209-117.eu-west-1.compute.amazonaws.com',database:'d6ropdjdvl5k1c',user:'gelogppghulxez',password:'e2b514fc66cc061391ab161d4e2c5f14272816058204a01b0be83cde7ffd9c3c',port:'5432',ssl:{rejectUnauthorized:false}});
